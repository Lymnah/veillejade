...
var GENERATED = {
  "date": "18.08.2026",
  "recherche": "Passage en revue de ce mardi 18 août, sur les 7 derniers jours, dans le triangle Yverdon – Rennaz – Morges et sur tes quatre axes (pédiatrie/néonat/urgences, formation, soins intensifs/neuroréhab adultes, management santé), sans filtre de langue. Le tour d'horizon habituel a été fait entièrement : jobup.ch (une quinzaine d'intitulés triés du plus récent au plus ancien), la recherche publique LinkedIn (plusieurs intitulés) et le site carrière de l'EHC. En revanche, deux portails que j'ouvre parfois en complément — le site de recrutement du CHUV et le portail spécialisé emploi-infirmier.ch — n'ont pas pu être consultés directement ce jour (l'accès n'était pas disponible) ; l'essentiel des postes du CHUV reste toutefois visible via jobup. La date limite de postulation est indiquée sous chaque offre quand l'annonce la précise.",
  "retenu": "Rien de neuf sur tes axes depuis lundi : aucune offre publiée ces 7 derniers jours ne franchit le seuil (6/10). Le tiroir « Autres pistes en zone, sous le seuil » (fermé par défaut, en bas de l'onglet) contient toujours les deux pistes repérées lundi et bien en zone : la réadaptation gériatrique de l'eHnv à Yverdon et le poste de cadre ICUS au Home Salem de Saint-Légier. Les deux belles offres du début du mois restent visibles dans l'onglet « semaines précédentes » et toujours d'actualité (délais non échus) : l'ICLS en pédiatrie du CHUV (100%, Lausanne — pédiatrie + formation) et l'infirmière petite enfance de la Fondation de La Côte (60%, Nyon — prévention et accompagnement parental, ton terrain IAIM).",
  "marche": "Très peu de mouvement en 24 heures. Sur jobup et LinkedIn, les seules nouveautés de la semaine sont soit hors zone (HUG Genève en néonat-pédiatrie et soins intermédiaires neuro, Crans-Montana/Valais, Hôpital de la Broye à Payerne, Fribourg/Marsens), soit de l'intérim et des agences de placement, soit du médico-social hors cœur (Fondation Saphir à Yverdon, HévivA à Chexbres/Echallens). Le poste de cadre ICUS de la Fondation Eben-Hézer (Saint-Légier) est réapparu en tête de liste « hier » : c'est la même annonce que la piste Home Salem déjà rangée dans le tiroir. Deux nouveaux postes d'infirmier·ère référent·e à l'APROMAD (Prilly, Epalinges) concernent les soins à domicile aux adultes et personnes âgées (CMS) : en zone mais hors de ton cœur, écartés.",
  "ecarte": "Hors zone (HUG/Genève néonat-pédiatrie et soins intermédiaires neuro, Crans-Montana/Valais, Hôpital intercantonal de la Broye à Payerne, Fribourg/Marsens) ; intérim et agences de placement (Assisteo, JBCgroup, Medicalis, Medpro, jobcourier, OK Job, Accès Personnel) ; soins à domicile / CMS aux adultes et personnes âgées, hors cœur (APROMAD infirmier·ère référent·e à Prilly et Epalinges ; ASPMAD infirmier·ère RAI 60% à Cossonay et référent·e en santé mentale au Nord vaudois) ; médico-social / handicap hors cœur (Fondation Saphir Yverdon 80% CDI ; HévivA à Chexbres et Echallens ; Asile des aveugles pooliste 10%) ; postes non-infirmiers (médecins/chef·fe·s de clinique, ergothérapeute, psychologues, secrétaires médicales, instrumentiste de bloc, aide-soignant·e/ASSC, chargé·e de recherche) ; en zone mais sous le seuil, rangées dans le tiroir « Autres pistes » de l'onglet Nouvelles (eHnv réadaptation gériatrique aiguë à Yverdon ; ICUS Home Salem/Fondation Eben-Hézer à Saint-Légier) ; reposts déjà traités ou déjà en liste (ICLS pédiatrie du CHUV, Clinique de La Source chef·fe coordinateur·trice, Institution de Lavigny neuroréhabilitation)."
};
