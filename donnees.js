...
var GENERATED = {
  "date": "26.08.2026",
  "recherche": "Passage en revue ce mercredi 26 août, sur les 7 derniers jours, dans le triangle Yverdon – Rennaz – Morges et sur tes quatre axes (pédiatrie/néonat/urgences, formation, soins intensifs/neuroréhab adultes, management santé), sans filtre de langue. Tour d'horizon complet en web : jobup.ch (une quinzaine d'intitulés triés du plus récent au plus ancien), la recherche publique LinkedIn (plusieurs intitulés) et le site carrière de l'EHC. En revanche, les portails que j'ouvre parfois en complément — le site de recrutement du CHUV, le portail spécialisé emploi-infirmier.ch et la vue LinkedIn connectée — n'ont pas pu être consultés directement ce jour (le navigateur d'appoint n'était pas disponible) ; l'essentiel des postes du CHUV reste toutefois visible via jobup. On reste sur la même semaine que lundi : ton onglet « Nouvelles » conserve donc les offres déjà retenues cette semaine. La date limite de postulation est indiquée sous chaque offre quand l'annonce la précise.",
  ...
  "marche": "Semaine calme qui se confirme, surtout côté cœur de métier clinique (pédiatrie/néonat/urgences) : aucune offre fraîche ne franchit le seuil aujourd'hui. Les annonces nouvelles du jour tombent toutes à côté : soit en zone mais hors de tes axes (Clinique CIC à Clarens, infirmier·ère de chirurgie ortho/gynéco/uro ; ASANTE SANA à Aigle, santé mentale adulte), soit hors zone (HUG et Rolex à Genève ; Hôpital du Valais à Sion ; HFR à Riaz ; Medpro à Petit-Lancy), soit de l'intérim (OK Job, Unique RH, Move UP, Helvetic Emploi, Accès Personnel), soit du médico-social / EMS / soins à domicile hors cœur (HévivA à Senarclens/Salavaux ; Fondation Belle Saison à Mont-sur-Rolle ; Fondation Balcons du Lac à Blonay ; Fondation des Maisons de retraite d'Aigle ; APROMAD à Prilly). L'offre pédiatrique fraîche sur jobup (APROMAD, infirmier·ère de nuit spécialisé·e en pédiatrie, soins à domicile) est un repost déjà vu en juin, donc non re-proposé.",
  "ecarte": "En zone mais hors de tes axes : Clinique CIC infirmier·ère de chirurgie 80–100% à Clarens (soins aigus adultes ortho/gynéco/uro, expérience chirurgicale demandée) ; Fondation de Nant infirmier·ère 80% en psychiatrie adulte (unité Vaudaire) ; ASANTE SANA infirmier·ère en santé mentale 80–100% à Aigle. Déjà proposées (reposts non re-listés) : APROMAD infirmier·ère de nuit spécialisé·e en pédiatrie (SIPeD, soins à domicile, déjà vu en juin) ; ICLS pédiatrie du CHUV et infirmière petite enfance de la Fondation de La Côte (dans « semaines précédentes ») ; cardiologie/chirurgie cardiaque du CHUV et cadres Bois-Gentil / La Source / eHnv / Home Salem (tiroir de la semaine du 17 août). Hors zone (HUG soins palliatifs / endocrinologie / Crans-Montana et Rolex infirmier d'entreprise à Genève ; Hôpital du Valais à Sion ; HFR à Riaz ; Medpro Petit-Lancy ; Essity Valais) ; intérim et agences de placement (OK Job, Unique Ressources Humaines, Move UP, Helvetic Emploi, Accès Personnel) ; médico-social / EMS / soins à domicile hors cœur (HévivA à Senarclens et Salavaux ; Fondation Belle Saison EMS à Mont-sur-Rolle ; Fondation Balcons du Lac à Blonay ; Fondation des Maisons de retraite du district d'Aigle ; Fondation EMS La Venoge à Penthalaz ; APROMAD référent·e et infirmiers d'appoints à Prilly ; Asile des aveugles pooliste 10%) ; postes non-infirmiers (secrétaires médicales, assistant·e·s social·e·s, aide-soignant·e/ASSC, instrumentiste et ATSSO de bloc, chef·fe de clinique et médecin, psychologues, diététicien·ne·s, cuisinier·ère·s, intendance, facturiste)."
};
