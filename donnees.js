/* donnees.js — DONNÉES de la veille. Seul fichier réécrit par /veille.
   Présentation = index.html / styles.css / app.js (ne PAS toucher ici).
   GENERATED est écrit pour Jade : langage clair, sans jargon technique. */

var GENERATED = {
  "date": "25.08.2026",
  "recherche": "Passage en revue ce mardi 25 août, sur les 7 derniers jours, dans le triangle Yverdon – Rennaz – Morges et sur tes quatre axes (pédiatrie/néonat/urgences, formation, soins intensifs/neuroréhab adultes, management santé), sans filtre de langue. Tour d'horizon complet en web : jobup.ch (une quinzaine d'intitulés triés du plus récent au plus ancien), la recherche publique LinkedIn (plusieurs intitulés) et le site carrière de l'EHC. En revanche, les portails que j'ouvre parfois en complément — le site de recrutement du CHUV, le portail spécialisé emploi-infirmier.ch et la vue LinkedIn connectée — n'ont pas pu être consultés directement ce jour (le navigateur d'appoint n'était pas disponible) ; l'essentiel des postes du CHUV reste toutefois visible via jobup. On reste sur la même semaine que lundi : les offres retenues s'ajoutent donc à ton onglet « Nouvelles » sans le vider. La date limite de postulation est indiquée sous chaque offre quand l'annonce la précise.",
  "retenu": "Une belle nouveauté aujourd'hui, en plein sur ton axe formation : la Fondation de Nant (Corsier-sur-Vevey, côté Riviera du triangle) recrute un·e responsable de formation (80–100%, CDI). Tu piloterais tout le dispositif de formation de l'institution — définir la politique de formation, organiser et suivre les programmes, repérer les besoins de développement des compétences —, exactement le prolongement de ton CAS de praticienne formatrice, mais porté au niveau institutionnel et managérial. Le profil demande une formation en pédagogie / formation d'adultes (que ton CAS couvre), sans exiger d'années précises : c'est une vraie candidature d'évolution vers un rôle de pilotage de la formation. Délai de postulation au 13 septembre. Reste par ailleurs d'actualité le poste de cadre (ICUS) du CHUV proposé lundi, et tes deux belles pistes du début du mois dans « semaines précédentes » (semaine du 10 août) : l'ICLS en pédiatrie du CHUV et l'infirmière petite enfance de la Fondation de La Côte à Nyon.",
  "marche": "Semaine toujours calme côté cœur de métier clinique (pédiatrie/néonat/urgences), mais deux nouveautés utiles : la responsable de formation de la Fondation de Nant ci-dessus, et — dans le tiroir « autres pistes » — un poste d'infirmier·ère en CTR (réadaptation) de l'EHC, ton employeur actuel, à Gilly, qui recoupe en partie tes années de neuroréhabilitation. Une annonce fraîche tombe bien dans le triangle mais à côté de tes axes : la Clinique CIC à Clarens cherche un·e infirmier·ère de chirurgie (ortho/gynéco/uro, 80–100%) — soins aigus adultes hors de tes axes et expérience chirurgicale demandée. À noter aussi une offre pédiatrique fraîche sur jobup mais déjà vue en juin (APROMAD, infirmier·ère de nuit spécialisé·e en pédiatrie, soins à domicile) : c'est un repost, donc non re-proposé. Le reste des nouveautés est soit hors zone (HUG, Rolex à Genève ; Hôpital du Valais à Sion ; HFR à Riaz ; Medpro/Medicalis à Genève), soit de l'intérim (OK Job, Unique RH, Move UP, Helvetic Emploi), soit du médico-social / EMS / soins à domicile hors cœur (HévivA à Senarclens/Salavaux ; Fondation Belle Saison à Mont-sur-Rolle ; APROMAD à Prilly/Epalinges ; Asile des aveugles pooliste 10%).",
  "ecarte": "En zone mais hors de tes axes : Clinique CIC infirmier·ère de chirurgie 80–100% à Clarens (soins aigus adultes ortho/gynéco/uro, expérience chirurgicale demandée) ; Fondation de Nant infirmier·ère 80% en psychiatrie adulte (unité Vaudaire, déjà vue) ; ASANTE SANA infirmier·ère en santé mentale 80–100% à Aigle. Déjà proposées (reposts non re-listés) : APROMAD infirmier·ère de nuit spécialisé·e en pédiatrie (SIPeD, soins à domicile, déjà vu en juin) ; ICLS pédiatrie du CHUV et infirmière petite enfance de la Fondation de La Côte (dans « semaines précédentes ») ; cardiologie/chirurgie cardiaque du CHUV et cadres Bois-Gentil / La Source / eHnv / Home Salem (tiroir de la semaine du 17 août). Hors zone (HUG soins palliatifs / endocrinologie et Rolex infirmier d'entreprise à Genève ; Hôpital du Valais à Sion ; HFR à Riaz ; Medpro Petit Lancy ; Medicalis Genève ; Essity Valais) ; intérim et agences de placement (OK Job, Unique Ressources Humaines, Move UP, Helvetic Emploi) ; médico-social / EMS / soins à domicile hors cœur (HévivA à Senarclens et Salavaux ; Fondation Belle Saison EMS à Mont-sur-Rolle ; Fondation Balcons du Lac à Blonay ; Fondation Echaud à Cugy ; Fondation EMS La Venoge à Penthalaz ; APROMAD référent·e et infirmiers d'appoints à Prilly/Epalinges ; Asile des aveugles pooliste 10%) ; postes non-infirmiers (secrétaires médicales, assistant·e·s social·e·s, aide-soignant·e/ASSC, instrumentiste de bloc, chef·fe de clinique et médecin assistant, psychologues, diététicien·ne·s, cuisinier·ère·s)."
};
...
var ANCIENNES = [
  ...
  },
  {
    ...
    "offres": [
      {
        "note": 8.8,
        "titre": "Infirmier·ère à l'Hôpital de jour de chirurgie pédiatrique & consultation pré-chirurgicale",
        "entreprise": "CHUV — Département femme-mère-enfant (DFME)",
        "lieu": "Lausanne",
        "taux": "80–100%",
        "date": "2026-06-18",
        "dateProp": "2026-06-18",
        "delai": "2026-06-30",
        "lien": "https://recrutement.chuv.ch/vacancy/infirmierere-aupres-de-lhdj-consultation-prechirurgicale-pediatrique-315589.html",
        "tags": [
          "Pédiatrie",
        ...
        "pourquoi": "Meilleure offre du 18.06 et publiée ce jour-là : poste infirmier 100% pédiatrique au cœur de métier de Jade, dans son ancien département (le DFME, qui regroupe néonat et pédiatrie — elle y a fait 3,5 ans de soins intermédiaires pédiatriques). Prise en charge d'enfants de quelques semaines à 18 ans en hôpital de jour de chirurgie + consultation pré-chirurgicale : accueil, préparation pré-op, surveillance post-anesthésique, gestion de la douleur, soins de plaies (elle est référente plaies/escarres !), enseignement et conseils de sortie aux familles, appels aux parents. Angle d'accroche : croiser « soins intermédiaires pédiatriques au CHUV + PALS + référente plaies + instructrice IAIM/accompagnement parental ».",
        "vigilance": "Taux 80–100% (au-dessus de la fourchette idéale 50–80%), mais hôpital de jour = horaires de journée, favorables à la QVT. Délai de postulation court : 30 juin 2026. Entrée souhaitée 1er septembre 2026.",
        "ethique": "good",
        "ethiqueTxt": "Aucun élément notable trouvé.",
        "repute": {
          "note": 3.5,
          "avis": "plusieurs",
          "source": "emploi-infirmier / Indeed",
      ...
      {
        "note": 8.6,
        "titre": "Infirmier·ère·s à 80-100% (CDI) — Neuroréhabilitation (SUN)",
        "entreprise": "Institution de Lavigny",
        "lieu": "Lavigny (axe Morges–Aubonne)",
        "taux": "80–100%",
        "date": "2026-06-07",
        "dateProp": "2026-06-16",
        "lien": "https://www.jobup.ch/fr/emplois/detail/01152778-b581-4a4c-b644-9dc0f6129342/",
        "tags": [
          "Neuroréhabilitation",
          "Formation / PF",
          "Interdisciplinaire",
        ...
        "pourquoi": "Le poste recoupe directement le parcours de Jade (3 ans de neuroréhabilitation adulte au CHUV) ET son volet formation, puisque la mission inclut explicitement la formation des étudiant·e·s et collègues, la PF étant citée comme atout. Cadre prestigieux : le Service universitaire de neuroréhabilitation (SUN) relie le CHUV et Lavigny. Valeurs affichées très alignées (bienveillance, équité, management collaboratif).",
        "vigilance": "Taux 80–100% (au-dessus de la fourchette idéale 50–80%) et horaires en 12h. Délai de postulation indiqué au 16 juin 2026 — à vérifier, car il peut être déjà échu.",
        "ethique": "good",
        "ethiqueTxt": "Aucun élément notable trouvé.",
        "repute": {
          "note": 3.4,
          ...
          "source": "Indeed",
          "statut": "positif",
          "txt": "Avis qualitatifs positifs (respect, soutien, bon encadrement) ; notes 3,4 à 4,5/5 selon la source, faible volume d'avis."
        }
      },
      {
        "note": 8,
        "titre": "Responsable du programme d'études postdiplômes en soins d'urgence",
        "entreprise": "CHUV",
        "lieu": "Lausanne",
        "taux": "80%",
        "date": "2026-06-15",
        "dateProp": "2026-06-18",
        "lien": "https://recrutement.chuv.ch/vacancy/responsable-programme-detudes-postdiplomes-en-soins-durgence-315325.html",
        "tags": [
          "Formation / praticienne formatrice",
          "Soins d'urgence",
          "CHUV",
          "CDI"
        ],
        "pourquoi": "En plein dans le 2e axe de Jade (formation/enseignement) : pilotage d'un programme de formation postdiplôme, dans son ancienne institution. Recoupe son CAS de praticienne formatrice, son expérience des urgences pédiatriques et sa certification PALS. Taux 80% pile dans la fourchette temps partiel.",
        "vigilance": "Poste de responsable de programme = fonction de cadre / ingénierie de formation, qui exige généralement une expérience confirmée en enseignement et possiblement un titre de niveau Master ou équivalent. Jade a un Bachelor + CAS PF (pas de Master) : à valider selon le cahier des charges.",
        "ethique": "good",
        "ethiqueTxt": "Aucun élément notable trouvé.",
        "repute": {
          "note": 3.5,
          ...
          "source": "emploi-infirmier / Indeed",
          "statut": "positif",
          "txt": "CHUV ~3,5/5 ; institution publique universitaire, conditions et formation continue reconnues."
        }
      },
      {
        "note": 7.9,
        "titre": "Infirmier·ère référent·e en pédiatrie 80-100% — soins pédiatriques à domicile (SIPeD)",
        "entreprise": "APROMAD (réseau AVASAD)",
        "lieu": "Vaud — sites Ouest & Nord (Ouest proche Morges/Renens)",
        "taux": "80–100%",
        "date": "2026-06-17",
        "dateProp": "2026-06-18",
        "delai": "2026-07-08",
        "lien": "https://www.jobup.ch/fr/emplois/detail/176cec59-5fdb-4b82-b2ff-d2d5aca732a3/",
        "tags": [
          "Pédiatrie",
          "Référent·e",
          "Accompagnement familial",
        ...
        "pourquoi": "Poste pédiatrique (cœur de métier) doublé d'un rôle de référent·e : suivi des plans de prise en charge interdisciplinaire, partenariat avec l'entourage et le réseau de soins, soins infirmiers au domicile d'enfants de 0 à 18 ans en situation de dépendance. Combine pédiatrie + coordination/encadrement + forte dimension d'accompagnement parental.",
        "vigilance": "Cadre = soins à domicile (et non hôpital aigu), avec déplacements ; permis de conduire obligatoire. Taux 80–100% (un peu au-dessus de la fourchette idéale). Minimum 2 ans d'expérience en pédiatrie requis (acquis). Délai de postulation : 8 juillet 2026.",
        "ethique": "good",
        "ethiqueTxt": "Aucun élément éthique notable (structure parapublique reconnue d'aide et de soins à domicile).",
        "repute": {
          "note": null,
          "avis": "mitigés",
          "source": "jobup / Indeed",
          "statut": "attention",
          "txt": "Réseau AVASAD : management humain et reconnaissance cités positivement, mais salaires jugés bas pour Vaud et management collaboratif perfectible. Pas de note chiffrée fiable."
        }
      },
      {
        "note": 7.8,
        "titre": "Chargé·e de formation — programme d'études postdiplômes en soins intensifs",
        "entreprise": "CHUV",
        "lieu": "Lausanne",
        "taux": "100%",
        "date": "2026-06-11",
        "dateProp": "2026-06-16",
        "lien": "https://www.jobup.ch/fr/emplois/detail/90d0e789-0509-429d-be95-af8089b49895/",
        "tags": [
          "Formation / praticienne formatrice",
          "Soins intensifs",
          "CHUV",
        ...
        "pourquoi": "Croise parfaitement les deux axes de Jade — sa formation (CAS de praticienne formatrice) et son expérience en soins intensifs (renforts SI COVID au CHUV). Poste d'enseignement au sein du programme post-diplôme SI, dans son ancienne institution.",
        "vigilance": "Taux 100% (au-dessus de la fourchette 50–80%). Rôle d'enseignement/ingénierie de formation plus que de soins au lit du patient ; exige probablement une expérience SI confirmée et/ou un titre de formation.",
        "ethique": "good",
        "ethiqueTxt": "Aucun élément notable trouvé.",
        "repute": {
          "note": 3.5,
      ...
      {
        "note": 7.2,
        "titre": "Infirmier·ère Clinicien·ne Spécialisé·e",
        "entreprise": "Fondation La Rozavère",
        "lieu": "Lausanne (Rovéréaz)",
        "taux": "80–100%",
        "date": "2026-06-08",
        "dateProp": "2026-06-16",
        "lien": "https://www.jobup.ch/fr/emplois/detail/1a363988-ae0f-4a98-9eb2-25070500ad07/",
        "tags": [
          "Référent clinique",
          "Formation",
          "Gériatrie / EMS",
        ...
        "pourquoi": "Rôle de référence clinique à fort volet formation : accompagnement des équipes, collaboration avec les praticiens formateurs et FEE, élaboration de formations intra-muros et développement des compétences — en plein dans l'axe « formation/encadrement » de Jade et son CAS PF. Fondation qui met « l'humain, l'innovation et la formation » au cœur, à Lausanne (proche domicile).",
        "vigilance": "Master en sciences infirmières requis (« ou en devenir ») : Jade a un Bachelor + CAS PF, pas de Master. Expérience demandée ≥ 5 ans auprès des personnes âgées ; spécialité gériatrie/EMS hors cœur pédiatrie.",
        "ethique": "good",
        "ethiqueTxt": "Aucun élément notable trouvé.",
        "repute": {
          "note": 4,
          ...
          "source": "Indeed",
          "statut": "positif",
          "txt": "Note Indeed ~4,0/5 ; équipes décrites comme accueillantes et flexibles sur les horaires, faible volume d'avis."
        }
      },
      {
        "note": 7,
        "titre": "Infirmier·ère ou ergothérapeute / art-thérapeute à l'Unité de réhabilitation",
        "entreprise": "CHUV",
        "lieu": "Lausanne",
        "taux": "100%",
        "date": "2026-06-09",
        "dateProp": "2026-06-16",
        "lien": "https://www.jobup.ch/fr/emplois/detail/478c1f81-e4b6-4e5e-976c-6221482387f6/",
        "tags": [
          "Réhabilitation",
          "CHUV",
          "Interdisciplinaire",
        ...
        "pourquoi": "Unité de réhabilitation, proche des 3 ans de Jade en neuroréhabilitation adulte au CHUV ; environnement interdisciplinaire qu'elle connaît bien.",
        "vigilance": "Taux 100%. Poste ouvert aussi aux ergo/art-thérapeutes (profil large) ; cadre adulte, hors cœur pédiatrie.",
        "ethique": "good",
        "ethiqueTxt": "Aucun élément notable trouvé.",
        "repute": {
          "note": 3.5,
      ...
      {
        "note": 6.9,
        "titre": "Infirmier·ère de nuit spécialisé·e en pédiatrie 20-100%",
        "entreprise": "APROMAD (réseau AVASAD)",
        "lieu": "Vaud / Lausanne (Epalinges)",
        "taux": "20–100% (horaire ou fixe)",
        "date": "2026-06-17",
        "dateProp": "2026-06-18",
        "delai": "2026-07-08",
        "lien": "https://www.jobup.ch/fr/emplois/detail/57ce21ba-0aa3-473b-8a71-0f186519e161/",
        "tags": [
          "Pédiatrie",
          "Veilles à domicile",
          "Accompagnement familial",
          "Chronicité / polyhandicap",
          "Flexible"
        ],
        "pourquoi": "Poste pédiatrique à domicile (enfants avec pathologies chroniques ou polyhandicap), centré sur la qualité des soins de nuit et le répit des familles : forte composante relationnelle et d'accompagnement parental, dans la lignée de la sensibilité de Jade (parentalité, massage bébé). Taux très flexible (20–100%), idéal pour un temps partiel choisi ; proximité Lausanne.",
        "vigilance": "Travail de nuit (veilles actives au domicile) et contrat « horaire » (revenu d'appoint) possible plutôt qu'un poste fixe — moins de stabilité. Minimum 2 ans d'expérience en pédiatrie requis (acquis). Délai : 8 juillet 2026.",
        "ethique": "good",
        "ethiqueTxt": "Aucun élément éthique notable (structure parapublique reconnue d'aide et de soins à domicile).",
        "repute": {
          "note": null,
          ...
          "source": "jobup / Indeed",
          "statut": "attention",
          "txt": "Réseau AVASAD : management humain et reconnaissance cités positivement, mais salaires jugés bas pour Vaud. Pas de note chiffrée fiable."
        }
      },
      {
        "note": 6.8,
        "titre": "Infirmier·ère certifié·e en soins intermédiaires (CHTH-CVAH)",
        "entreprise": "CHUV",
        "lieu": "Lausanne",
        "taux": "80–100%",
        "date": "2026-06-15",
        "dateProp": "2026-06-18",
        "lien": "https://recrutement.chuv.ch/vacancy/infirmierere-certifiee-en-soins-intermediaires-chthcvah-315245.html",
        "tags": [
        ...
        "pourquoi": "Soins intermédiaires : un type de soin que Jade a pratiqué (3,5 ans en soins intermédiaires pédiatriques + renforts soins intensifs adultes COVID au CHUV). Environnement hospitalier aigu universitaire qu'elle connaît, à Lausanne ; taux compatible temps partiel.",
        "vigilance": "Unité adulte (chirurgie thoracique / cardio-vasculaire), hors cœur pédiatrie. L'intitulé demande une certification en soins intermédiaires que Jade n'a pas formellement — à vérifier si « en cours / à acquérir » est accepté.",
        "ethique": "good",
        "ethiqueTxt": "Aucun élément notable trouvé.",
        "repute": {
          "note": 3.5,
      ...
      {
        "note": 6.3,
        "titre": "Adjoint·e à la direction des soins (Départements DAL-DNC)",
        "entreprise": "CHUV",
        "lieu": "Lausanne",
        "taux": "80–100%",
        "date": "2026-06-16",
        "dateProp": "2026-06-18",
        "lien": "https://recrutement.chuv.ch/vacancy/adjointe-a-la-direction-des-soins-aux-departements-daldnc-315365.html",
        "tags": [
        ...
        "pourquoi": "Rôle d'encadrement supérieur dans le prolongement de l'axe management/formation de Jade ; le DNC (neurosciences cliniques) recoupe ses 3 ans de neuroréhabilitation adulte au CHUV.",
        "vigilance": "Poste de cadre supérieur (adjoint·e à la direction des soins) : exige une expérience managériale confirmée et probablement un titre de gestion/Master. Écart de séniorité important avec le profil actuel de Jade.",
        "ethique": "good",
        "ethiqueTxt": "Aucun élément notable trouvé.",
        "repute": {
          "note": 3.5,
      ...
      {
        "note": 6.3,
        "titre": "Infirmier·ère chef·fe d'Unité de soins — soins continus de médecine interne",
        "entreprise": "CHUV",
        "lieu": "Lausanne",
        "taux": "à définir",
        "date": "2026-06-15",
        "dateProp": "2026-06-16",
        "lien": "https://www.jobup.ch/fr/emplois/detail/925273cf-d31e-43a4-9581-e508dd7d9b3b/",
        "tags": [
          "Encadrement / ICUS",
          "Soins continus",
          "CHUV",
        ...
        "pourquoi": "Rôle d'encadrement (cheffe d'unité), dans le prolongement de son axe formation/management et de son expérience de responsabilité d'étage.",
        "vigilance": "Poste de cheffe d'unité : exige une expérience managériale confirmée. Médecine interne adulte, hors pédiatrie ; taux non précisé.",
        "ethique": "good",
        "ethiqueTxt": "Aucun élément notable trouvé.",
        "repute": {
          "note": 3.5,
      ...
      {
        "note": 6.2,
        "titre": "Infirmier·ère spécialisé·e en soins intensifs (F/H)",
        "entreprise": "EHC — Ensemble Hospitalier de la Côte",
        "lieu": "Morges",
        "taux": "100% (temps plein)",
        "date": "2026-06-17",
        "dateProp": "2026-06-21",
        "lien": "https://www.linkedin.com/jobs/view/4426878040/",
        "tags": [
        ...
        "pourquoi": "Trouvée via LinkedIn (absente de jobup). Poste de soins intensifs adultes à l'Hôpital de Morges — l'établissement et l'employeur actuels de Jade (EHC) : une mobilité interne possible, dans une structure dont elle connaît déjà les valeurs (Responsabilité, Proximité, Humanité, Compétence) et l'engagement formateur. Recoupe son expérience SI adultes (renforts COVID au CHUV — patients intubés/extubés, cardiaques et traumatiques). Localisation idéale (Morges, son site actuel).",
        "vigilance": "Intitulé « spécialisé·e en soins intensifs » : le diplôme post-grade SI est vraisemblablement attendu — Jade a l'expérience SI mais pas la certification (à clarifier : poste possiblement ouvert avec « formation SI en cours/à acquérir »). Temps plein (100%), au-dessus de sa fourchette 50–80%. Hors cœur pédiatrie/formation. Comme c'est son employeur actuel, à n'envisager que si une réorientation interne vers les SI l'intéresse. Aucun délai de postulation indiqué.",
        "ethique": "good",
        "ethiqueTxt": "Aucun élément éthique notable (institution régionale reconnue, réseau de soins public/parapublic vaudois).",
        "repute": {
          "note": null,
          "avis": "connu en interne",
          "source": "employeur actuel",
      ...
      {
        "note": 6.2,
        "titre": "Infirmier·ère d'appoint en pédiatrie — soins pédiatriques à domicile (SIPeD), Horaire",
        "entreprise": "APROMAD (réseau AVASAD)",
        "lieu": "Vaud — sites Ouest & Nord (Ouest proche Morges/Renens)",
        "taux": "10–50% (horaire / revenu complémentaire)",
        "date": "2026-06-17",
        "dateProp": "2026-06-19",
        "delai": "2026-07-08",
        "lien": "https://www.jobup.ch/fr/emplois/detail/199be25a-a116-42af-beb3-0132bbb4f292/",
        "tags": [
          "Pédiatrie",
          "Soins à domicile",
          "Accompagnement familial",
        ...
        "pourquoi": "Seule offre vraiment nouvelle ce run à passer le seuil, et en plein cœur de métier : soins infirmiers pédiatriques au domicile (ou école/crèche) d'enfants de 0 à 18 ans en situation de dépendance, au sein de l'équipe cantonale SIPeD. Forte composante d'accompagnement et de collaboration avec les familles — directement alignée avec le profil pédiatrique de Jade et sa sensibilité IAIM (parentalité, massage bébé). Taux d'appoint très flexible : peut servir de complément à son poste actuel à l'EHC.",
        "vigilance": "Contrat « horaire / revenu complémentaire » (poste d'appoint, pas un poste fixe) — peu de stabilité et taux 10–50% sous la fourchette 50–80% visée. Permis de conduire obligatoire (déplacements à domicile). Minimum 2 ans d'expérience en pédiatrie requis (acquis). Délai de postulation : 8 juillet 2026.",
        "ethique": "good",
        "ethiqueTxt": "Aucun élément éthique notable (structure parapublique reconnue d'aide et de soins à domicile).",
        "repute": {
          "note": null,
      ...
      {
        "note": 6.2,
        "titre": "Infirmier·ère référent·e somatique (60-100%) — CMS de Renens",
        "entreprise": "APREMADOL (réseau AVASAD)",
        "lieu": "Renens VD (Ouest lausannois)",
        "taux": "60–100%",
        "date": "2026-06-15",
        "dateProp": "2026-06-16",
        "lien": "https://www.jobup.ch/fr/emplois/detail/1f22af81-3e4f-4b5b-92d5-8d903429705c/",
        "tags": [
          "Référent·e / responsable de situation",
          "Soins à domicile",
          "Horaires de journée",
          "CDI"
        ],
        "pourquoi": "Rôle de référent·e / responsable de situation (composante encadrement et coordination réseau, proche de l'axe formation de Jade). Conditions de vie favorables : horaires principalement de journée (7h–17h), 5 à 6 semaines de vacances, CCT parapublique, formation continue AVASAD ; taux flexible 60–100% compatible temps partiel, à Renens (proche Lausanne/Morges).",
        "vigilance": "Soins à domicile (CMS), hors cœur métier pédiatrie/soins aigus. Avis salariés évoquant un salaire moyen et une communication interne perfectible.",
        "ethique": "good",
        "ethiqueTxt": "Aucun élément notable trouvé (structure parapublique reconnue d'aide et soins à domicile vaudoise).",
        "repute": {
          "note": null,
          "avis": "mitigés",
          "source": "Indeed / jobup",
          "statut": "attention",
          "txt": "Avis AVASAD mitigés : management humain et reconnaissance cités positivement, mais salaire et communication critiqués. Pas de note chiffrée fiable."
        }
      },
      {
        "note": 6.1,
        "titre": "Infirmier·ère en soins intensifs à 90-100%",
        "entreprise": "Clinique Cecil (groupe Hirslanden)",
        "lieu": "Lausanne",
        "taux": "90–100%",
        "date": "2026-06-19",
        "dateProp": "2026-06-21",
        "lien": "https://www.jobup.ch/fr/emplois/detail/457dcd21-63d5-43cc-ae94-9aa8ed6ed79e/",
        "tags": [
          "Soins intensifs adultes",
          "Hôpital aigu",
          "Plateau technique",
        ...
        "pourquoi": "Seule offre vraiment nouvelle ce run à atteindre le seuil. Soins intensifs adultes (chirurgie cardiaque, viscérale, thoracique, neurochirurgie ; ventilation invasive/non-invasive, hémodiafiltration, contre-pulsion) : recoupe directement l'expérience de Jade en SI adultes (renforts COVID au CHUV — patients intubés/extubés, cardiaques et traumatiques, pratique réflexive et soins techniques SI). Cadre hospitalier aigu à plateau technique, à Lausanne (sur l'axe), structure « à taille humaine », jusqu'à 7 semaines de vacances, contrat FLEX et temps partiel proposés, formation continue. Angle d'accroche : valoriser les renforts SI adultes au CHUV + les soins techniques SI déjà acquis, et l'envie de consolider une spécialisation SI.",
        "vigilance": "Spécialisation d'expert·e en soins intensifs explicitement « requise » : Jade a une expérience SI adultes (renforts COVID) mais pas le diplôme post-grade SI — à clarifier si « en cours / à acquérir » est accepté. Taux 90–100% (au-dessus de la fourchette idéale 50–80%). Hors cœur pédiatrie/formation. Clinique privée (Hirslanden). Aucun délai de postulation indiqué (entrée souhaitée 1er avril 2026 ou à convenir).",
        "ethique": "good",
      ...
      {
        "note": 6.1,
        "titre": "Infirmier·ère diplômé·e — Service de médecine du personnel et d'entreprise",
        "entreprise": "CHUV",
        "lieu": "Lausanne",
        "taux": "50%",
        "date": "2026-06-16",
        "dateProp": "2026-06-18",
        "lien": "https://recrutement.chuv.ch/vacancy/infirmierere-diplomee-pour-le-service-de-medecine-du-personnel-et-dentreprise-315105.html",
        "tags": [
          "Santé au travail",
          "Prévention",
          "Horaires de journée",
        ...
        "pourquoi": "Conditions et taux idéaux pour un temps partiel choisi : 50%, horaires de journée, au CHUV (employeur public reconnu). Composante prévention / conseil qui peut faire écho à son intérêt pour la promotion de la santé.",
        "vigilance": "Santé au travail : hors du cœur de métier (pédiatrie / soins aigus) et sans volet pédiatrique ni formation marqué. Intérêt surtout pour la qualité de vie / l'équilibre.",
        "ethique": "good",
        "ethiqueTxt": "Aucun élément notable trouvé.",
        "repute": {
          "note": 3.5,
...
/* Garde : permet à outils/veille.mjs de lire le même fichier que le navigateur. */
if (typeof module !== "undefined") { module.exports = { GENERATED, NOUVELLES, ANCIENNES }; }
